...
#elif defined(ARDUINO_AMEBA) || defined(ARDUINO_ARCH_AMEBAD) || defined(CONFIG_PLATFORM_8721D)
...
#elif defined(ARDUINO_AMEBA) || defined(ARDUINO_ARCH_AMEBAD) || defined(CONFIG_PLATFORM_8721D)
#define WEBSOCKETS_NETWORK_TYPE NETWORK_AMEBAD
